<?php /* Smarty version Smarty-3.1.18, created on 2017-05-02 09:10:37
         compiled from "C:\ecjia-daojia-29\content\apps\stats\templates\merchant\keywords_stats.dwt.php" */ ?>
<?php /*%%SmartyHeaderCode:334459084d0d860b93-56493458%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de867baad9aff2ea81c362e502faa4f32bf27bdd' => 
    array (
      0 => 'C:\\ecjia-daojia-29\\content\\apps\\stats\\templates\\merchant\\keywords_stats.dwt.php',
      1 => 1487583421,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '334459084d0d860b93-56493458',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59084d0dbaf9e1_04826790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59084d0dbaf9e1_04826790')) {function content_59084d0dbaf9e1_04826790($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_header.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '334459084d0d860b93-56493458');
content_59084d0d941cc1_99036340($_smarty_tpl);
...
<div class="page-header">
	<div class="pull-left">
		<h3><?php if ($_smarty_tpl->tpl_vars['ur_here']->value) {?><?php echo $_smarty_tpl->tpl_vars['ur_here']->value;?>
<?php }?></h3>
  	</div>
	<?php if ($_smarty_tpl->tpl_vars['action_link']->value) {?>
	<div class="pull-right">
	  <a class="btn btn-primary" id="sticky_a" href="<?php echo $_smarty_tpl->tpl_vars['action_link']->value['href'];?>
&start_date=<?php echo $_smarty_tpl->tpl_vars['start_date']->value;?>
&end_date=<?php echo $_smarty_tpl->tpl_vars['end_date']->value;?>
"><i class="glyphicon glyphicon-download-alt"></i> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<div class="row">
	<div class="col-lg-12 panel-heading">
    	<form class="form-inline pull-right" action="<?php echo $_smarty_tpl->tpl_vars['search_action']->value;?>
" method="post" name="theForm">
			<span><?php echo smarty_function_lang(array('key'=>'stats::statistic.start_date'),$_smarty_tpl);?>
</span>
			<input class="form-control start_date w110" name="start_date" type="text" placeholder="<?php echo smarty_function_lang(array('key'=>'stats::statistic.start_date_msg'),$_smarty_tpl);?>
" value="<?php echo $_smarty_tpl->tpl_vars['start_date']->value;?>
">
			<span><?php echo smarty_function_lang(array('key'=>'stats::statistic.end_date'),$_smarty_tpl);?>
</span>
			<input class="form-control end_date w110" name="end_date" type="text" placeholder="<?php echo smarty_function_lang(array('key'=>'stats.statistic.end_date_msg'),$_smarty_tpl);?>
" value="<?php echo $_smarty_tpl->tpl_vars['end_date']->value;?>
">
			<button class="btn btn-primary screen-btn" type="submit"><i class="fa fa-search" data-original-title="" title=""></i> <?php echo smarty_function_lang(array('key'=>'system::system.button_search'),$_smarty_tpl);?>
</button>
    	</form>
	</div>
</div>
    ...
    <div class="col-lg-12">
        <section class="panel">
        	<table class="table table-striped table-hover" id="smpl_tbl">
        		<thead>
        			<tr>
        				<th><?php echo smarty_function_lang(array('key'=>'stats::statistic.keywords'),$_smarty_tpl);?>
</th>
        				<th class="w120"><?php echo smarty_function_lang(array('key'=>'stats::statistic.hits'),$_smarty_tpl);?>
</th>
        				<th class="w100"><?php echo smarty_function_lang(array('key'=>'stats::statistic.date'),$_smarty_tpl);?>
</th>
        			</tr>
        		</thead>
        		<tbody>
        			<?php  $_smarty_tpl->tpl_vars['list'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['list']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['keywords_data']->value['item']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['list']->key => $_smarty_tpl->tpl_vars['list']->value) {
$_smarty_tpl->tpl_vars['list']->_loop = true;
?>
        			<tr>
        				<td><?php echo $_smarty_tpl->tpl_vars['list']->value['keyword'];?>
</td>
...
?>
        	    	<tr><td class="dataTables_empty" colspan="3"><?php echo smarty_function_lang(array('key'=>'system::system.no_records'),$_smarty_tpl);?>
</td></tr>
        	  		<?php } ?>
        		</tbody>
        	</table>
    	</section>
    	<?php echo $_smarty_tpl->tpl_vars['keywords_data']->value['page'];?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_footer.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '334459084d0d860b93-56493458');
content_59084d0da72fc3_90094520($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_59084d0d941cc1_99036340')) {function content_59084d0d941cc1_99036340($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_block_t')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\block.t.php';
...
<?php if ($_valid && !is_callable('content_59084d0da72fc3_90094520')) {function content_59084d0da72fc3_90094520($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
?> 
