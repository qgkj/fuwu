<?php /* Smarty version Smarty-3.1.18, created on 2017-05-02 08:17:56
         compiled from "C:\ecjia-daojia-29\content\apps\shopguide\templates\merchant\shop_guide.dwt.php" */ ?>
<?php /*%%SmartyHeaderCode:22266590840b4a3b336-73545985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01bd6536189a4a86bf673eded8c02232b0b0f93b' => 
    array (
      0 => 'C:\\ecjia-daojia-29\\content\\apps\\shopguide\\templates\\merchant\\shop_guide.dwt.php',
      1 => 1487583420,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '22266590840b4a3b336-73545985',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_590840b4e89945_42915326',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_590840b4e89945_42915326')) {function content_590840b4e89945_42915326($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_header.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '22266590840b4a3b336-73545985');
content_590840b4af9ec9_43627941($_smarty_tpl);
		...
		<section class="panel">
			<header class="panel-heading">
				<?php if (!$_GET['step']||$_GET['step']=='1') {?>
          		<?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.base_info'),$_smarty_tpl);?>

          		<?php } elseif ($_GET['step']=='2') {?>
          		<?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.goods_info'),$_smarty_tpl);?>
        	...
        	<div class="panel-body">
           		<div class="stepy-tab">
	             	<ul id="default-titles" class="stepy-titles clearfix">
	         			<li id="step1" class="<?php if (!$_GET['step']||$_GET['step']=='1') {?>current-step<?php }?>"><div>第一步</div></li>
	    				<li id="step2" class="<?php if ($_GET['step']=='2') {?>current-step<?php }?>"><div>第二步</div></li>
	                   	<li id="step3" class="<?php if ($_GET['step']=='3') {?>current-step<?php }?>"><div>第三步</div></li>
	                </ul>
				</div>     
				<form class="form-horizontal cmxform" id="default" action="<?php echo smarty_function_url(array('path'=>'shopguide/merchant/step_post'),$_smarty_tpl);?>
<?php if ($_GET['step']) {?>&step=<?php echo $_GET['step'];?>
<?php }?>" method="post" name="theForm" enctype="multipart/form-data" data-toggle='from'>
				    <?php if (!$_GET['step']||$_GET['step']=='1') {?>
...
店铺公告：<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                            ...
                            <div class="controls col-lg-6">
                                <textarea class="form-control required" name="shop_notice"><?php echo $_smarty_tpl->tpl_vars['data']->value['shop_notice'];?>
</textarea>
                            </div>
...
店铺简介：<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                            ...
                            <div class="controls col-lg-6">
                                <textarea class="form-control required" name="shop_description"><?php echo $_smarty_tpl->tpl_vars['data']->value['shop_description'];?>
</textarea>
                            </div>
                            <span class="input-must">
                                <span id="email-error" class="require-field error" style="color:#FF0000,">*</span>
						...
						<input class="btn btn-info f_r" type="submit" value="<?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.next_step'),$_smarty_tpl);?>
"/>
				    </fieldset>
				    ...
				    <fieldset class="step2" id="default-step-1">
				        <div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_goods_cat'),$_smarty_tpl);?>
</label>
							<div class="controls col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_goods_name'),$_smarty_tpl);?>
</label>
							<div class="controls col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_goods_num'),$_smarty_tpl);?>
</label>
							<div class="col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_goods_price'),$_smarty_tpl);?>
</label>
							<div class="col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_add_recommend'),$_smarty_tpl);?>
</label>
							<div class="col-lg-6">
								<div class="checkbox">
									<input id="is_best" type="checkbox" name="is_best" checked />
									<label for="is_best"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.is_best'),$_smarty_tpl);?>
</label>
									
									<input id="is_new" type="checkbox" name="is_new" checked />
									<label for="is_new"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.is_new'),$_smarty_tpl);?>
</label>
									
									<input id="is_hot" type="checkbox" name="is_hot" checked />
									<label for="is_hot"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.is_hot'),$_smarty_tpl);?>
</label>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_goods_desc'),$_smarty_tpl);?>
</label>
							<div class="col-lg-6">
						...
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.label_upload_image'),$_smarty_tpl);?>
</label>
							<div class="col-lg-6">
...
"/>
				    ...
				    <fieldset class="step3" id="default-step-2">
				    	<div class="jumbotron text-center">
				  	  		<?php echo smarty_function_lang(array('key'=>'shopguide::shopguide.result_info'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_footer.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '22266590840b4a3b336-73545985');
content_590840b4c8e417_55489389($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_590840b4af9ec9_43627941')) {function content_590840b4af9ec9_43627941($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_block_t')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\block.t.php';
...
<?php if ($_valid && !is_callable('content_590840b4c8e417_55489389')) {function content_590840b4c8e417_55489389($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
?> 
