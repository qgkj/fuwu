<?php /* Smarty version Smarty-3.1.18, created on 2017-05-02 09:17:56
         compiled from "C:\ecjia-daojia-29\content\apps\merchant\templates\merchant\mh_switch.dwt.php" */ ?>
<?php /*%%SmartyHeaderCode:694359084ec4e856f9-20224277%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7a5fbc6e3f40314cb7b47a106ab336ee3b43f72' => 
    array (
      0 => 'C:\\ecjia-daojia-29\\content\\apps\\merchant\\templates\\merchant\\mh_switch.dwt.php',
      1 => 1487583418,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '694359084ec4e856f9-20224277',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59084ec51b4d28_17521624',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59084ec51b4d28_17521624')) {function content_59084ec51b4d28_17521624($_smarty_tpl) {?><?php if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_header.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '694359084ec4e856f9-20224277');
content_59084ec4f21d89_31045247($_smarty_tpl);
...
<div class="alert alert-info">
	...
	<strong>温馨提示：</strong><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
当您的店铺还未完善店铺信息、未完整上架商品以及您临时有事不能正常运营时可暂时下线店铺。<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="col-lg-12">
        <section class="panel">
            <div class="panel-body">
                ...
                <h4><?php echo $_smarty_tpl->tpl_vars['tips']->value;?>
</h4>
                <?php } else { ?>
...
店铺上下线：<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</label>
                            <div class="col-lg-6">
                                <!-- <div id="danger-toggle-button"  data-toggleButton-width="170">
                                    <input type="checkbox" checked="checked">
                                </div> -->
                                <input id="close1" type="radio" name="shop_close" value="0" <?php if ($_smarty_tpl->tpl_vars['merchant_info']->value['shop_close']==0) {?> checked="true" <?php }?>  />
                                <label for="close1">上线</label>
                                <input id="close2" type="radio" name="shop_close" value="1" <?php if ($_smarty_tpl->tpl_vars['merchant_info']->value['shop_close']==1) {?> checked="true" <?php }?>  />
                        ...
                        <div class="form-group">
    					  	...
    					  	<div class="controls col-lg-6">
    					      	<input class="form-control" name="mobile" id="mobile" placeholder="请输入手机号码" type="text" value="<?php echo $_smarty_tpl->tpl_vars['merchant_info']->value['mobile'];?>
" readonly/>
    					  	</div>
    					  	<?php if ($_smarty_tpl->tpl_vars['type']->value!='edit_apply') {?>
    					 	<a class="btn btn-primary" data-url="<?php echo smarty_function_url(array('path'=>'merchant/merchant/get_code_value'),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("library/common_footer.lbi.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '694359084ec4e856f9-20224277');
content_59084ec50c0ab2_12392957($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_59084ec4f21d89_31045247')) {function content_59084ec4f21d89_31045247($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_block_t')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\block.t.php';
...
<?php }?><?php }} ?>
<?php /* Smarty version Smarty-3.1.18, created on 2017-05-02 09:17:57
         compiled from "C:\ecjia-daojia-29\content\apps\merchant\templates\merchant\library\common_footer.lbi.php" */ ?>
<?php if ($_valid && !is_callable('content_59084ec50c0ab2_12392957')) {function content_59084ec50c0ab2_12392957($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.url.php';
if (!is_callable('smarty_function_hook')) include 'C:\\ecjia-daojia-29\\content\\system\\smarty\\function.hook.php';
?> 
